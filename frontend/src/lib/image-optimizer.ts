...
/**
 * Kiểm tra xem URL có phải là external image service không
 */
function isExternalImageService(url: string): boolean {
...
export function optimizeImage(
  ...
  const opts: ImageOptimizeOptions = typeof options === 'string' 
